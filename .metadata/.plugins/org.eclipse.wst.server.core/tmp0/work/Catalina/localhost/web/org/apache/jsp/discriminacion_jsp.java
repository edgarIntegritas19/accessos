 ...
 * Generated at: 2020-06-12 03:16:52 UTC
...
public final class discriminacion_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sql = "SELECT * FROM `CUsuario` WHERE nom_usu LIKE '"+nombre+"' && password LIKE '"+password+"' && id_tipo = "+TipoUsuario;
Statement sentencia = connection.createStatement();
 rs = sentencia.executeQuery(sql);
                            out.println("<br> "+rs.next());
